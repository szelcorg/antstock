...
public class BarData implements Serializable {
    ...
    public BarData( Date dateTime, double open, double high, double low, double close, long volume) {
     ...
     */
    public BarData(Date dateTime, double open, double high, double low, double close, long volume, long openInterest) {
